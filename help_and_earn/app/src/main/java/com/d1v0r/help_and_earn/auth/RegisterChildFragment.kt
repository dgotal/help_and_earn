...
@Composable
fun RegisterChildScreen(navController: NavController, registerViewModel: RegisterViewModel) {
    ...
    var parentId = registerViewModel.auth.currentUser?.uid ?: return
        ...
        Column(
            ...
            RegisterChildFooter(
                onRegisterClick = {
                    ...
                    registerViewModel.registerChildUser(user)
                },
            )
        }
    }
